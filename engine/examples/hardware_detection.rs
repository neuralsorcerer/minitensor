...
fn main() {
    ...
    println!("Estimated execution time: {:?}", execution_plan.estimated_total_time);
    println!("Parallelization strategy: {:?}", execution_plan.parallelization_strategy);
    println!("Memory allocation strategy: {:?}", execution_plan.memory_plan.allocation_strategy);
}