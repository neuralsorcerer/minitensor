...
_FUNCTIONAL_FORWARDERS = (
    ...
    "bincount",
    "masked_fill",
    # The free-function forms of the operators and their second spellings,
    # defined in `_elementwise` and attached to `functional` before this list
    # is walked. They ride the same forwarding as everything else so that
    # nothing has to know where a name was written.
    "add",
    "sub",
    "mul",
    "div",
